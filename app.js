...
function enter() {
  ...
  if (inputText !== "" && key === "Enter") {
    // If the user has pressed enter and textbox is not empty
...
function checkEvent(e) {
  if (e.target.classList.contains("checkbox")) {//to check a todo-list-item
    ...
    e = e.target.parentElement.parentElement.childNodes[0]; //accessing tag(input) with class(todo-list-item)
